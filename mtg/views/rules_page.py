...
if "deck_upload_popover" not in st.session_state:
    st.session_state.deck_upload_popover = False
...
def toggle_popover():
    st.session_state.deck_upload_popover = True
...
if st.session_state.deck_upload_popover == True:
    deck_upload()
    st.rerun()
...
with st.sidebar:
    ...
    st.button("Upload Deck", on_click=toggle_popover)
